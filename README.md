# C++ 학습 기록 — Day 1 (opp01~opp14)

> 학원에서 C 13일차까지 배운 뒤 시작한 C++ 강의 첫날 실습 코드 모음입니다. Visual Studio에서 작성/실행했으며, 각 예제마다 개념 설명과 실제 실행 결과를 함께 정리했습니다.

## 목차

- [opp01. cout으로 화면에 출력하기](#opp01-cout으로-화면에-출력하기)
- [opp02. cin으로 두 숫자 입력받아 덧셈하기](#opp02-cin으로-두-숫자-입력받아-덧셈하기)
- [opp03. 두 수 사이의 정수 합 구하기](#opp03-두-수-사이의-정수-합-구하기)
- [opp04. 여러 개의 char 배열로 정보 입력받기](#opp04-여러-개의-char-배열로-정보-입력받기)
- [opp05. 함수 오버로딩 (다중정의)](#opp05-함수-오버로딩-다중정의)
- [opp06. 디폴트 매개변수 2개 함께 쓰기](#opp06-디폴트-매개변수-2개-함께-쓰기)
- [opp07. inline 함수](#opp07-inline-함수)
- [opp08. namespace(이름공간) 기초](#opp08-namespace이름공간-기초)
- [opp09. 중첩 namespace와 별칭(alias)](#opp09-중첩-namespace와-별칭alias)
- [opp10. bool 자료형, while(true)+break, sizeof](#opp10-bool-자료형-whiletruebreak-sizeof)
- [opp11. bool을 반환하는 함수로 양수/음수 판별하기](#opp11-bool을-반환하는-함수로-양수음수-판별하기)
- [opp12. 참조자(reference) — 변수에 별명 붙이기](#opp12-참조자reference-변수에-별명-붙이기)
- [opp13. 배열 원소에 참조자 걸기](#opp13-배열-원소에-참조자-걸기)
- [opp14. 참조자와 포인터를 함께 쓰기](#opp14-참조자와-포인터를-함께-쓰기)
...
VAL: 3047
PTR이 가리키는 값: 3047
num1의 주소: 0x7ffe6f68f6cc
ptr에 저장된 주소값: 0x7ffe6f68f6cc
